...
#ifndef __PYX_HAVE_API__transcripter
...
static PyObject *(*__pyx_api_f_12transcripter_transcribe)(PyObject *) = 0;
#define transcribe __pyx_api_f_12transcripter_transcribe
...
static int import_transcripter(void) {
  PyObject *module = 0;
  module = PyImport_ImportModule("transcripter");
  if (!module) goto bad;
  if (__Pyx_ImportFunction_3_2_4(module, "transcribe", (void (**)(void))&__pyx_api_f_12transcripter_transcribe, "PyObject *(PyObject *)") < 0) goto bad;
...
#endif /* !__PYX_HAVE_API__transcripter */
